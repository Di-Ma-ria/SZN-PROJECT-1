...
import {createProductSchema, updateProductSchema, updateStatusSchema, updateStockSchema, updateVariantStockSchema,
} from '../validation/productValidation.js';

import {
  // Public 
  getAllProducts, getSingleProduct, searchProducts, getSearchSuggestions, getProductsByCategory, getProductsByCategorySlug, getProductsByBrand, getFeaturedProducts, getNewArrivals, getDeals, getRelatedProducts, compareProducts,
...
createProduct, getMyProducts, getMyProductStats, getProductAnalytics, updateProduct, addProductImages,
  ...
  adminGetAllProducts, getPendingProducts, adminProductStats, updateProductStatus, toggleFeaturedProduct} from '../controllers/productController.js';
...
ProductRoutes.get('/seller/my-products', authMiddleware, isSeller, getMyProducts);

ProductRoutes.get('/seller/my-stats', authMiddleware, isSeller, getMyProductStats);
...
// GENERIC ROUTES — this comes after all named routes
